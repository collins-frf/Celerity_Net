...
name1 = loss + str(lr) + "_" + activation + "snap=True_snap_only=False_" + str(filters) +"_noslope_"
name2 = loss + str(lr) + "_" + activation + "snap=True_snap_only=True_" + str(filters) +"_noslope_"
name3 = loss + str(lr) + "_" + activation + "snap=False_snap_only=False_" + str(filters) +"_noslope_"
